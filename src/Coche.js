...
class Modelo extends THREE.Object3D {
    constructor(gui, titleGui, tubo) {
        ...
        this.coche_nivelIntermedio.position.y = 2*tubo.getRadio(); // Lo colocamos en la parte superior del tubo
        // this.coche.position.y = tubo.getRadio();
...
// --- ANIMACION DEL COCHE (movimiento) ---//
    ...
    animacion(){
        ...
        var origen = {t: 0};
        var destino = {t: 1};
        var velocidad =  5000; // 5000 ms = 5 segundos. Esto es el tiempo que tardará en recorrer el camino
      //  var altura = 1.5;
